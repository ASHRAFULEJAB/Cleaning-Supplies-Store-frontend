    ...
    <div>
      <div className="min-h-screen bg-gray-50/50">
        ...
        >
          <div className="relative border-b border-white/20">
            <Link className="flex items-center gap-4 py-6 px-8" href="/">
              <h6
                className="block  text-center antialiased tracking-normal font-sans text-base 
              font-semibold leading-relaxed text-white lg:ml-6"
              >
                <Image src={logo} height={120} width={140} alt="loog" />
              </h6>
            </Link>
            <button
              className="middle none font-sans font-medium text-center uppercase transition-all
               disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none w-8
                max-w-[32px] h-8 max-h-[32px] rounded-lg text-xs text-white
                  ...
                  <button
                    className="middle none font-sans font-bold center transition-all
                     disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none
                      text-xs py-3 rounded-lg bg-[#00739E]
                       text-white shadow-md  hover:shadow-lg
                        hover:bg-[#00739E] active:opacity-[0.85] w-full flex items-center
        ...
        <div className="p-4 xl:ml-80">
          ...
          >
            <div
              className="flex   items-center justify-between w-full px-4 mx-auto 
          ...
          <div className="mt-12">
            ...
            <section className="container px-4 mx-auto">
              <div className="flex flex-col">
               ...
               md:rounded-lg"
                ...
                divide-gray-700"
                  ...
                  "
                        >
                          {dashboardProducts?.data?.map((dashProduct) => (
                            <DashboardTable
                              key={dashProduct?._id}
              ...
              <div className="flex items-center justify-between mt-6">
                <a
                  href="#"
                  className="flex items-center px-5 py-2 text-sm text-white
            capitalize transition-colors duration-200  border rounded-md gap-x-2 
            bg-gray-900 
            ...
            hover:"
                ...
                <div className="items-center hidden md:flex gap-x-3">
                  <a
                    href="#"
                    className="px-2 py-1 text-sm text-blue-500 rounded-md 
               bg-blue-100/60"
                  >
                    1
                  </a>
              ...
              text-gray-300 hover:bg-gray-100"
                ...
                <a
                  href="#"
                  className="flex items-center px-5 py-2 text-sm text-white capitalize transition-colors 
            duration-200border rounded-md gap-x-2  
            bg-gray-900 
